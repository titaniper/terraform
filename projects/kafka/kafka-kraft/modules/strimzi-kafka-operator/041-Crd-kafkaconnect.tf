# Source: https://github.com/strimzi/strimzi-kafka-operator/blob/0.37.0/helm-charts/helm3/strimzi-kafka-operator/crds/041-Crd-kafkaconnect.yaml

resource "kubernetes_manifest" "kafkaconnects-kafka-strimzi-io" {
